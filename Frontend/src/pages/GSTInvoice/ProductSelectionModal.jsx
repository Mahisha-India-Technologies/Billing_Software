...
const handleAdd = async () => {
  try {
    ...
    // Force async render before processing (important!)
    await new Promise((resolve) => setTimeout(resolve, 50));

    // Simulate async or call async-safe handler
    const result = await Promise.resolve(onAddProducts(selectedProducts));
  ...
  sx={{
    ...
    alignItems: "center",
    gap: 1.5,
    minWidth: "220px", // ensures consistent button width
  }}
>
  <span style={{color: isAdding ? 'gray' : 'white'}}>Add Selected Products</span>
